...
const agents = [
  { id: "max_credit", name: "Max Credit", specialty: "Personal Credit", position: [-4, 0, -2] as [number, number, number], color: "#D4AF37" },
  { id: "biz_credit", name: "Biz Builder Brock", specialty: "Business Credit", position: [-1.5, 0, -3.5] as [number, number, number], color: "#2196F3" },
  { id: "credit_repair", name: "Fix-It Frankie", specialty: "Credit Repair", position: [1.5, 0, -3.5] as [number, number, number], color: "#E53935" },
