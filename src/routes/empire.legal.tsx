    ...
    <div className="min-h-screen p-6 md:p-10 max-w-4xl mx-auto">
      ...
      {tab === "disclosures" && (
        <div className="space-y-4">
          ...
          <Accordion title="8. 2026 FCRA Compliance (Updated)">
            <p className="font-bold text-foreground">FAIR CREDIT REPORTING ACT — 2026 UPDATES</p>
            <p>AI KOACHED's credit repair and credit dispute services comply with the 2026 FCRA modernization updates. Key changes affecting our services:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Specific Disputes Required.</strong> We generate highly specific, evidence-based dispute letters — not generic templates, which are no longer accepted under 2026 FCRA standards.</li>
              <li><strong>Higher Verification Standards.</strong> We educate members on the new furnisher verification requirements: furnishers must now provide documentation of accuracy, not just automated confirmation.</li>
              <li><strong>Inconclusive Data Removal.</strong> Under 2026 rules, bureaus must delete items where furnishers cannot prove accuracy. We help members leverage this consumer protection.</li>
              <li><strong>Cross-Bureau Discrepancy Detection.</strong> Multi-bureau data mismatches are now classified as high-risk errors. Our AI workers scan for these discrepancies.</li>
              <li><strong>10-Day Preliminary Investigation.</strong> High-risk errors now trigger a mandatory 10-day preliminary investigation by bureaus.</li>
              <li><strong>Expanded Identity Theft Protections.</strong> Faster fraud block processing and mandatory deletion of fraudulent accounts.</li>
            </ul>
            <p className="text-[10px] mt-2">Per Fair Credit Reporting Act, 15 U.S.C. § 1681 et seq., as updated March 2026.</p>
          </Accordion>

          {/* 9 — FTC AI Policy Statement Compliance */}
          <Accordion title="9. FTC AI Policy Statement Compliance">
            <p className="font-bold text-foreground">FTC POLICY STATEMENT ON AI AND SECTION 5 (Effective March 11, 2026)</p>
            <p>AI KOACHED operates in full compliance with the FTC's 2026 Policy Statement on AI and Section 5 of the FTC Act, which clarifies consumer protection requirements for AI-powered products:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Transparency.</strong> AI KOACHED clearly discloses that our business coaching, credit analysis, and document preparation are powered by artificial intelligence. Users always know when they are interacting with an AI agent.</li>
              <li><strong>No Deceptive Claims.</strong> Our AI agents are trained to never make false promises, guarantee specific outcomes, or misrepresent the capabilities of AI-generated content.</li>
              <li><strong>AI-Generated Content Disclosure.</strong> All documents, business plans, dispute letters, and recommendations generated by AI KOACHED are clearly labeled as AI-generated and should be independently verified.</li>
              <li><strong>Data Handling.</strong> We process user data solely for the purpose of providing business building services. We do not sell user data to third parties.</li>
              <li><strong>Human Oversight.</strong> AI-generated legal documents (operating agreements, dispute letters) are presented as drafts for member review — not as final legal documents.</li>
              <li><strong>No Unfair Practices.</strong> Our AI agents do not engage in manipulative design patterns, dark patterns, or deceptive urgency tactics.</li>
            </ul>
            <p className="text-[10px] mt-2">Per FTC Policy Statement RAI-US-NA-ENFORCE-2026, effective March 11, 2026.</p>
          </Accordion>

          {/* 10 — International Operations */}
          <Accordion title="10. International Operations Disclaimer">
            <p>AI KOACHED provides entity formation guidance for businesses in multiple countries. Important notices for international members:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li>AI KOACHED is a US-based platform operated by a Wyoming C-Corporation</li>
              <li>International entity formation guidance is educational only — we are NOT licensed to practice law in any foreign jurisdiction</li>
              <li>Members forming entities outside the US should consult a licensed attorney in the relevant jurisdiction</li>
              <li>Tax implications of cross-border business structures vary by country and should be verified with a qualified tax professional</li>
              <li>Platform availability may be restricted in certain jurisdictions based on local regulations</li>
              <li>The B2B Community Marketplace operates under US commercial law — international transactions may be subject to additional local regulations</li>
              <li>$KOACHED token availability may be restricted in jurisdictions that prohibit utility tokens</li>
            </ul>
          </Accordion>

          {/* 11 — TSR Compliance */}
          <Accordion title="11. Telemarketing Sales Rule (TSR) Compliance">
            <p>AI KOACHED complies with the FTC's Telemarketing Sales Rule (16 CFR Part 310) as it applies to credit repair services:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>No Advance Fees.</strong> AI KOACHED NEVER charges fees for credit repair services before those services have been fully performed. Billing occurs only after each service round is completed and verified.</li>
              <li><strong>Written Contract.</strong> All credit repair services require a written agreement before services begin.</li>
              <li><strong>3-Day Cancellation.</strong> Members may cancel credit repair services within 3 business days of signing with no penalty and a full refund.</li>
              <li><strong>Truthful Representations.</strong> AI KOACHED does not represent that any specific credit score improvement will occur. All outcomes depend on individual circumstances.</li>
            </ul>
            <p className="text-[10px] mt-2">Per 16 CFR Part 310, Telemarketing Sales Rule, as amended December 2024.</p>
          </Accordion>
